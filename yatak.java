...
import com.example.kemal.splashscreen.R;
import com.example.kemal.splashscreen.utils.AsyncCompareTask;
...
public class yatak extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
        ...
        if (imgToRecognize != null && imgScene != null) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    AsyncCompareTask task = new AsyncCompareTask(yatak.this);
